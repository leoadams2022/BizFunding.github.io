...
var StateTimezone = [{"State":"Alabama","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[205,251,256,334,938]},{"State":"Alaska","TimeZone":"America/Anchorage","UTCoffset":-9,"DTSutcOffset":-8,"AreaCodes":[907]},{"State":"Arizona","TimeZone":"America/Phoenix","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[480,520,602,623,928]},{"State":"Arkansas","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[479,501,870]},{"State":"California","TimeZone":"America/Los_Angeles","UTCoffset":-8,"DTSutcOffset":-7,"AreaCodes":[209,213,279,310,323,408,415,424,442,510,530,559,562,619,626,628,650,657,661,669,707,714,747,760,805,818,820,831,858,909,916,925,949,951]},{"State":"Colorado","TimeZone":"America/Denver","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[303,719,720,970]},{"State":"Connecticut","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[203,475,860,959]},{"State":"Delaware","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[302]},{"State":"Florida","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[239,305,321,352,386,407,561,727,754,772,786,813,850,863,904,941,954]},{"State":"Georgia","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[229,404,470,478,678,706,762,770,912]},{"State":"Hawaii","TimeZone":"Pacific/Honolulu","UTCoffset":-10,"DTSutcOffset":-9,"AreaCodes":[808]},{"State":"Idaho","TimeZone":"America/Denver","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[208,986]},{"State":"Illinois","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[217,224,309,312,331,618,630,708,773,779,815,847,872]},{"State":"Indiana","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[219,260,317,463,574,765,812,930]},{"State":"Iowa","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[319,515,563,641,712]},{"State":"Kansas","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[316,620,785,913]},{"State":"Kentucky","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[270,364,502,606,859]},{"State":"Louisiana","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[225,318,337,504,985]},{"State":"Maine","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[207]},{"State":"Maryland","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[240,301,410,443,667]},{"State":"Massachusetts","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[339,351,413,508,617,774,781,857,978]},{"State":"Michigan","TimeZone":"America/New_York","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[231,248,269,313,517,586,616,734,810,906,947,989]},{"State":"Minnesota","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[218,320,507,612,651,763,952]},{"State":"Mississippi","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[228,601,662,769]},{"State":"Missouri","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[314,417,573,636,660,816]},{"State":"Montana","TimeZone":"America/Denver","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[406]},{"State":"Nebraska","TimeZone":"America/Chicago","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[308,402,531]},{"State":"Nevada","TimeZone":"America/Los_Angeles","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[702,725,775]},{"State":"NewHampshire","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[603]},{"State":"NewJersey","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[201,551,609,640,732,848,856,862,908,973]},{"State":"NewMexico","TimeZone":"America/Denver","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[505,575]},{"State":"NewYork","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[212,315,332,347,516,518,585,607,631,646,680,716,718,838,845,914,917,929,934]},{"State":"NorthCarolina","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[252,336,704,743,828,910,919,980,984]},{"State":"NorthDakota","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[701]},{"State":"Ohio","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[216,220,234,330,380,419,440,513,567,614,740,937]},{"State":"Oklahoma","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[405,539,580,918]},{"State":"Oregon","TimeZone":"America/Los_Angeles","UTCoffset":-8,"DTSutcOffset":-7,"AreaCodes":[458,503,541,971]},{"State":"Pennsylvania","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[215,223,267,272,412,445,484,570,610,717,724,814,878]},{"State":"RhodeIsland","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[401]},{"State":"SouthCarolina","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[803,843,854,864]},{"State":"SouthDakota","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[605]},{"State":"Tennessee","TimeZone":"America/Chicago","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[423,615,629,731,865,901,931]},{"State":"Texas","TimeZone":"America/Chicago","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[210,214,254,281,325,346,361,409,430,432,469,512,682,713,726,737,806,817,830,832,903,915,936,940,956,972,979]},{"State":"Utah","TimeZone":"America/Denver","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[385,435,801]},{"State":"Vermont","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[802]},{"State":"Virginia","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[276,434,540,571,703,757,804]},{"State":"Washington","TimeZone":"America/Los_Angeles","UTCoffset":-8,"DTSutcOffset":-7,"AreaCodes":[206,253,360,425,509,564]},{"State":"WestVirginia","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[304,681]},{"State":"Wisconsin","TimeZone":"America/Chicago","UTCoffset":-6,"DTSutcOffset":-5,"AreaCodes":[262,414,534,608,715,920]},{"State":"Wyoming","TimeZone":"America/Denver","UTCoffset":-7,"DTSutcOffset":-6,"AreaCodes":[307]},{"State":"Washington,DC","TimeZone":"America/New_York","UTCoffset":-5,"DTSutcOffset":-4,"AreaCodes":[202]}];
//_____________________________How to Call an AreaCode ____________________
//__________________________StateTimezone.flat()[0].AreaCodes[0]
//=================================================================================
//----------function's to use ------------------
const getTimeString = ({
    hours,
...
function drawTable(jsData, tbody) {
    ...
    for (var i = 0; i < jsData.length; i++) {
        ...
        td = tr.insertCell(tr.cells.length);
        td.setAttribute("align", "center");
        td.setAttribute("class", "TimeDiff");
		td.setAttribute("id", "TimeDiffId");
        td.innerHTML = '';
        //----------------------------------		
        td = tr.insertCell(tr.cells.length);
        td.setAttribute("align", "center");
        ...
        td = tr.insertCell(tr.cells.length);
        td.setAttribute("align", "center");
        td.setAttribute("class", "EditBtTd");
		td.setAttribute("id", "EditBtTd");
        td.innerHTML = '';
...
function String12HInto24HNumber(TimeString){
	if(TimeString.length == 10){
		var Myhour = Number(TimeString.charAt(0));
		var Mymin = Number(TimeString.charAt(2)+TimeString.charAt(3));
		var Myzone = TimeString.charAt(8)+TimeString.charAt(9);
	}else if(TimeString.length == 11){
		var Myhour = Number(TimeString.charAt(0)+TimeString.charAt(1));
		var Mymin = Number(TimeString.charAt(3)+TimeString.charAt(4));
		var Myzone = TimeString.charAt(9)+TimeString.charAt(10);
	}
	if(Myzone == 'AM'){
		if(Myhour == 12){
			Hour24 = 0;
	...
	var time24hourarray = [{'Hour24':Hour24,'Mymin':Mymin,'Myzone':Myzone}];
    return time24hourarray;
}
//======================================================
// general var's 
var alarm_list = []; // we save the list here
...
// pervent the submit event at the form
...
// geting the saved data if thers any
function GetList(){
    const SavedList = JSON.parse(localStorage.getItem('list'));
    if (SavedList == null) {} else if (SavedList != null) {
        alarm_list = SavedList;
        drawTable(alarm_list.flat(), 'table_body');
    }
}

// opening and closeing the adding from
function openForm() {
	...
	document.getElementById('CloseSpan').innerText = 'Close';
}
...
function closeForm() {
    ...
    document.getElementById('CloseBtn').style.background = '#f4511e';//#f4511e
	document.getElementById('AddCallSpan').innerHTML = 'Add Call Bcak';
    document.forms[0].reset();
}
//-----------------------------------------------


//addin the delete button and it's function
function AddDeleteBt() { 
    ...
    for (let i = 0; i < DeleteBt.length; i++) {
	    list[i].id = Number([i]);
        DeleteBt[i].innerHTML = `<button id="DeleteBt${[i]}" class="DeleteBt" onclick="DeleteBtFun(${[i]})"><span>Delete</span></button>`;
    }
}
function DeleteBtFun(myid) {
...
function AddEditBt() { 
 	var list = alarm_list.flat();
    const EditBt = document.getElementsByClassName('EditBtTd');
    for (let i = 0; i < EditBt.length; i++) {
        EditBt[i].innerHTML = `<button id="EditBt${[i]}" class="EditBt" onclick="EditBtFun(${[i]})"><span>Edit</span></button>`;
    }
}
		  
function EditBtFun(myid){
	     openForm();
		 document.getElementById('CancelBtn').style.display = 'initial';
		 document.getElementById('CloseSpan').innerHTML = 'Delete';
		 document.getElementById('AddCallSpan').innerHTML = 'Update Call Bcak';
		 document.getElementById('CloseBtn').style.background = 'red';//#f4511e
		 var list = alarm_list.flat();
		 phone_number.value = list[myid].phone_number;
		 var timestring = alarm_list.flat()[0].time;
		     if (timestring.length == 10){
				 var Myhour = timestring.charAt(0);
				 var Mymin = timestring.charAt(2)+timestring.charAt(3);
				     if(Mymin.charAt(0) == '0'){
						 Mymin = '0';
					 }
		         var Myzone = timestring.charAt(8)+timestring.charAt(9);
			 }else if (timestring.length == 11){
				 var Myhour = timestring.charAt(0)+timestring.charAt(1);
				 var Mymin = timestring.charAt(3)+timestring.charAt(4);
				     if(Mymin.charAt(0) == '0'){
						 Mymin = '0';
					 }
		         var Myzone = timestring.charAt(9)+timestring.charAt(10);
		...
		min.value = Mymin;
		zone.value = Myzone;
		note.value = list[myid].note;
//---------makeing a temp copy of the item for the cancel function
	...
	tempArray = [{
        "phone_number": list[myid].phone_number,
        "time": alarmString,
        "note": list[myid].note,
        "stete": list[myid].stete,
        "Timezone": list[myid].Timezone,
		"id": myid,
        "wentoff": list[myid].wentoff,
    }]; 
//-----------------------------------------------------------
		DeleteBtFun(myid);
		Nothing();
...
function Cancel(){
	alarm_list.push(tempArray);
	drawTable(alarm_list.flat(), 'table_body');
	AddDeleteBt();// add ing the delete button function
    AddEditBt();
	localStorage.setItem('list', JSON.stringify(alarm_list));
	Nothing();
	closeForm();
...
//------------------------------------------------------------------------------
//------------------------------------------------------------
//--------------------ViweRNtime_AlarmGoOff_RedBackground--------------------
function ViweRNtime_AlarmGoOff_RedBackground() {
    var list = alarm_list.flat();
    var RnTime = document.getElementsByClassName('time');
	var Mytr = document.getElementsByClassName('Mytr');
	var AlarmTime = document.getElementsByClassName('AlarmTime');
	...
	var TimezoneTD = document.getElementsByClassName('Timezone');
		//__________________Cureent time_______________
	var currentTime = document.getElementById("current_time");
    const currentDate = new Date();
    currentTime.innerHTML = currentDate.toLocaleTimeString("en-US");
	//======================================
	//_____________ViweRNtime____________________
    for (let i = 0; i < RnTime.length; i++) {
        let time = new Date();
        time = time.toLocaleTimeString("en-US", {
            timeZone: list[i].Timezone
        });
        RnTime[i].innerHTML = time;
    }
	//======================================
	//______________AlarmGoOff______________________
	...
	//======================================
	//______________RedBackground______________________
    for (let i = 0; i < list.length; i++) {
        if (list[i].wentoff === 'yes') {
            Mytr[i].style.background = '#c33002';
        }
    }
	//=======================================
	//______________viwe time at entry________________
	if (num.length > 2) {
	...
	//==============================================
	//______________convert Alramtime to localTime________________
	var EgTime = new Date();
		var EgYear = EgTime.getFullYear();
		var EgMonth = EgTime.getMonth()+1;
		var EgDay = EgTime.getDate();
	   for (let i = 0; i < AlarmTime.length; i++){
		      var AlarmTime24USA = String12HInto24HNumber(AlarmTime[i].innerText);
			  var AlarmTimeHour24 = AlarmTime24USA[0].Hour24;
			  var AlarmTimeMin24 = AlarmTime24USA[0].Mymin;
			  var alarmInEgyTime = minitz(EgYear, EgMonth, EgDay, AlarmTimeHour24, AlarmTimeMin24, 00, TimezoneTD[i].innerText).toLocaleString("en-EN");
			  TimeDiff[i].innerText = alarmInEgyTime.substring(12);
	   }
	   
}
setInterval(ViweRNtime_AlarmGoOff_RedBackground, 1000);
//if there is no call backs viwe a massage
function Nothing(){
	   var list = alarm_list.flat();
	   if(list.flat().length == 0){
		   document.getElementById('NoItem').style.display = 'block';
	   }else if (list.flat().length > 0){
...
function add_alarm() {
	...
	//geting the timezone for the number 
    var num = phone_number.value;
    var area_code = num.charAt(0) + num.charAt(1) + num.charAt(2);
    var AC = area_code;
    var stetearray = filter(AreaCodeState, Number(AC), 'Area_Code');
...
function ShowNotification(){
 const notification = new Notification("Call Back Time",{
                       body: "Click Here to See More Details",
					   icon: "https://cdn-icons-png.flaticon.com/512/4514/4514070.png"
                        });
						
						notification.onclick = (e) =>{
						   window.location.href = "https://leoadams2022.github.io/BizFunding.github.io/CBA_index.html"
						   };   
}
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
